                          ...
                          <tbody>
                            <tr>
                              <td style="width:180px;">
                                <img alt="logo-nomads" height="auto" src="{{ url('frontend/images/logo_nomads@2x.png') }}" style="border:none;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="180" />
                              </td>
                            </tr>
                          </tbody>
                        </table>
                          ...
                          <tbody>
                            <tr>
                              <td style="width:550px;">
                                <img alt="bg-details-email" height="auto" src="{{ url('./Storage/'.$data->travel_package->galleries[0]->image) }}" style="border:none;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="550" />
                              </td>
                            </tr>
                          </tbody>
                        </table>
                          ...
                          <tbody>
                            <tr>
                              <td align="left" style="font-size:0px;padding:10px 25px;padding-right:25px;padding-left:25px;word-break:break-word;">
                                <div style="font-family:Assistant, Halvetica, Arial, sans-serif;font-size:18px;line-height:20px;text-align:left;color:#071c4d;">Hi, {{ $data->user->name }} <br /><br /> Tiket digital kamu sudah berhasil dicetak. <br /> Booking ID <strong> {{ $data->id }} </strong></div>
                              </td>
                            </tr>
                            <tr>
                              <td align="left" style="font-size:0px;padding:10px 25px;padding-right:25px;padding-left:25px;word-break:break-word;">
                            ...
                            <tr>
                              <td align="center" vertical-align="middle" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:separate;line-height:100%;">
                                  <tr>
                                    <td align="center" bgcolor="#FF9E53" role="presentation" style="border:none;border-radius:1px;cursor:auto;mso-padding-alt:10px 25px;background:#FF9E53;" valign="middle">
                                      <a href="{{ url('checkout/'. $data->id) }}" style="display:inline-block;background:#FF9E53;color:#ffffff;font-family:Assistant, Halvetica, Arial, sans-serif;font-size:18px;font-weight:bold;line-height:120%;margin:0;text-decoration:none;text-transform:none;padding:10px 25px;mso-padding-alt:0px;border-radius:1px;"> Check Detail </a>
                                    </td>
                                  </tr>
                                </table>
                              </td>
          ...
          <tr>
            <td style="direction:ltr;font-size:0px;padding:20px 0;padding-bottom:20px;padding-top:0px;text-align:center;">
              ...
              <div class="mj-column-per-100 mj-outlook-group-fix" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                    ...
                    <tr>
                      <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                        <table cellpadding="0" cellspacing="0" width="100%" border="0" style="color:#000000;font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:22px;table-layout:auto;width:100%;border:none;">
                          <tr>
                            <td style="width: 50px;">
                              <img src="{{ url('frontend/images/ic_support-2.png') }}" width="50px" alt="ic_support_contact">
                            </td>
                            <td style="
                font-size:18px;
                padding-left:10px;
                ...
                "> support@nomads.ID <br> 0857-1472-9590 </td>
                          </tr>
                        </table>
                      </td>
                    </tr>
