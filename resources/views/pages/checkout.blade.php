                                        ...
                                        <tr>
                                            <td class="align-middle">
                                                <img 
                                                    ...
                                                    src="https://ui-avatars.com/api/?name={{ $detail->username }}" height="60"
                                                >
                                            </td>
                        ...
                        <div class="card card-details card-right">
                            ...
                            <div class="bank">
                                <div class="bank-item pb-3">
                                    <img src="{{ url('frontend/images/ic_bank.png') }}" alt="ic_logo_bank" class="bank-image">
